    ...
    <footer className="bg-gray-900 text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <h3 className="text-2xl font-playfair font-semibold mb-6 text-primary-300">HappyTeeth</h3>
            ...
            <ul className="space-y-3">
              <li>
                <button
                  ...
                  className="text-gray-300 hover:text-primary-300 transition-colors font-inter"
                >
                  Home
                </button>
              </li>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300 font-inter">
              ...
              <p className="text-primary-300 font-medium">(555) 123-4567</p>
            </div>
          </div>
          <div>
